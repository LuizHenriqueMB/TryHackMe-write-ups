...
<img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*jBeW948VXe5d3H5BAvxJcA.png" width="900" alt=Print01>

Em seguida, encontramos o payload utilizado pelo atacante para criar um shell reverso.

<img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*5ny02jGopUAmh7w88-f-7A.png" width="900" alt="Print02">
...
<img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*FPIf3tgYBEitkkqHt-Jfkw.png" width="900" alt="Print03">
...
<img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*53kWSYap0fgaWXEC6B-Nmw.png" width="900" alt="Print04">
...
<img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*992yfyh8hAsls17kfyMJ3Q.png" width="900" alt="Print05">
...
<img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*7t_AlXarJMVJkv9vM4YGwA.png" width="900" alt="Print06">
...
<img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*dENHvcrODZL_hy5UyXCtdQ.png" width="900" alt="Print07">

E também possui um `salt` fixo presente no código

<img src="https://miro.medium.com/v2/resize:fit:828/format:webp/1*PgQ_dNOLehRmF8uQmZq0yQ.png" width="900" alt="Print08">
...
<img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*gtrKHMRsOBmpU3vevtiYiQ.png" width="900" alt="Print09">
...
<img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*e4GYELUkFvXvOQzCEhs7Iw.png" width="900" alt="Print10">
...
<img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*cX0cm_3hVxwULs9pfMc9Iw.png" width="900" alt="Print11">

Acessando a aplicação web nos deparamos com uma mensagem implantada pelo atacante

<img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*ZrSJRzi_Ug4sJZ57Z04XpA.png" width="900" alt="Print12">
...
<img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*J_PIchlywYtX9wUerBHLGg.png" width="900" alt="Print13">

Assim que conseguimos acesso, obtemos a user flag no diretório do usuário james

<img src="https://miro.medium.com/v2/resize:fit:786/format:webp/1*pvnKTNZ0tM_coYIywJdKxQ.png" width="900" alt="Print14">
...
<img src="https://miro.medium.com/v2/resize:fit:750/format:webp/1*4juPSLVuGQav0pXsS19GYA.png" width="900" alt="Print15">
...
<img src="https://miro.medium.com/v2/resize:fit:1100/format:webp/1*uZlQnpJxfr2aRjMS5VxK4A.png" width="900" alt="Print16">
